...
WhiteBIT offers professional-grade [colocation](../glossary#colocation) services for [high-frequency trading (HFT)](../glossary#high-frequency-trading-hft) and algorithmic trading operations. Place your trading servers close to our exchange's [matching engine](../glossary#matching-engine) to achieve minimal [latency](../glossary#latency) and enhanced trading performance.

## Performance Highlights

- **Ultra-Low [Latency](../glossary#latency)**: Execute trades in just 5 milliseconds
- **Direct Connection**: Connect directly to WhiteBIT's [matching engine](../glossary#matching-engine)
...
1. Contact our institutional sales team
...
- Security: IP address pool required for whitelisting
...
- Network configuration including [cross-connect](../glossary#cross-connect) setup
- Security setup
- Performance testing
...
- 10Gbit dedicated [cross-connect](../glossary#cross-connect)
- DDoS protection
