...
<Alert 
  type="info" 
  header="Region-Aware URLs"
  message={
    <>
      All code examples below use a <code>BASE_URL</code> constant that you should set based on your region:
      <ul className="mt-2 ml-4 list-disc">
        <li><strong>Global</strong>: <code>BASE_URL = "https://whitebit.com"</code></li>
        <li><strong>EU</strong>: <code>BASE_URL = "https://whitebit.eu"</code></li>
      </ul>
      <p className="mt-2">
        <strong>Your current region base URL:</strong> <code><RegionalBaseUrlText /></code>
      </p>
      <p className="mt-2 text-sm">
        Simply replace the <code>BASE_URL</code> constant in each code example with the appropriate value for your region.
      </p>
    </>
  }
/>
...
<ApiEndpoint method="GET" path="/auth/login?clientId=YOUR_CLIENT_ID&state=SECURE_RANDOM_STATE" />
...
<Tabs items={['TypeScript', 'PHP', 'Go', 'Java', 'Python']}>
  ...
  // Region-aware base URL - set based on your region:
...
📖 [View complete documentation](/private/http-main-v4#get-depositwithdraw-history)
...
📖 [View complete documentation](/private/http-trade-v4#convert-history)
...
📖 [View complete documentation](/private/http-trade-v4#query-executed-orders)
...
📖 [View complete documentation](/private/http-trade-v4#query-executed-order-history)
...
📖 [View complete documentation](/private/http-main-v4#main-balance)
...
📖 [View complete documentation](/private/http-trade-v4#trading-balance)
