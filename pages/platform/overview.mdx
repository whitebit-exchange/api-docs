...
import { URL_TYPE_MAIN } from "@/constants";

WhiteBIT API provides comprehensive access to our trading platform through both `public` and `private` endpoints. By using any WhiteBIT API endpoints, you confirm your agreement to the <RegionalUrl type={URL_TYPE_MAIN} path="/terms/api">Terms of Use</RegionalUrl>.
