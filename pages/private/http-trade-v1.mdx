...
Endpoint example: <Code><RegionalBaseUrlText />/api/v1/{"{endpoint}"}</Code>
...
#### This endpoint is deprecated. Use [V4 Query Active Orders endpoint](./http-trade-v4#query-unexecutedactive-orders) instead
