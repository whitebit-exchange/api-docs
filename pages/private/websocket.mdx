...
Query and subscribe to [active orders](./../glossary.md#active-orders) (orders not yet executed). The WebSocket methods use `ordersPending_*` naming for API compatibility.
