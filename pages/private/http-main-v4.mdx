...
This endpoint generate a JWT token using API key authentication.
...
This endpoint returned card token in exchange on card number for fiat card withdraws.
...
| address               | String         | **Yes**                                                                                                             | Target address (wallet address for cryptocurrencies, identifier/card token for [fiat](./../glossary.md#fiat) currencies)                                                                                                                                                |
