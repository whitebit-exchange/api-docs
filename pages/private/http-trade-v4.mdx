...
showAfter="2025-06-09T09:00:00Z" 
/>
...
<ApiEndpoint method="POST" path="/api/v4/collateral-account/positions/history" />
...
message="This feature will be available in the next release. Please, follow our changelog for updates." />
...
<ApiEndpoint method="POST" path="/api/v4/collateral-account/hedge-mode/update" />
