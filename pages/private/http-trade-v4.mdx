...
- [Private HTTP API V4 for trading](#private-http-api-v4-for-trading)
  ...
  - [Spot](#spot)
    ...
    - [Query Active Orders](#query-unexecutedactive-orders)
  ...
  - [Collateral](#collateral)
    ...
    - [Query Active Conditional Orders](#query-unexecutedactive-conditional-orders)
    - [Query Active OCO Orders](#query-unexecutedactive-oco-orders)
...
```json
{
  ...
  "maintenanceMarginRequirement": "1.2446758120916304" // maintenance margin requirement
}
```
