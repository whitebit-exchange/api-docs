...
| clientOrderId   | String        | **No**    | Identifier should be unique and contain letters, dashes, numbers, dots or underscores. Search by this identifier works within 24 hours after creation. |
| market          | String        | **Yes**   | Available [market](./../glossary.md#market). Example: BTC_USDT                                                                |
