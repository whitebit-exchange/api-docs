...
<Card className="my-6">
  <CardHeader>
    <CardTitle>Cancelling Orders Using ClientOrderId</CardTitle>
  </CardHeader>
  <CardContent>
    <div className="text-foreground/80 mb-4">
      You can now cancel orders using either the `orderId` or `clientOrderId` through the Cancel Order endpoint.
    </div>

    <div className="space-y-6">
      <div>
        <h4 className="font-medium mb-2 text-foreground/90">Cancel Order Endpoint</h4>
        <div className="text-sm text-foreground/80 mb-2">
